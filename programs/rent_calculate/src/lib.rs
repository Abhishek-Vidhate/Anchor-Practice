// this code is same to create system owned account program
// here we are just caluclating rent for AccountData struct i.e fixed size of account i.e using fixed rent i.e rent calculating
